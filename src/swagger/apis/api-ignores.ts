...
import { ControllerFile_Imp, ControllerFile_Imp_Ign } from '../types/ctrler-types';
 ...
 *  and returns it.
 */
function find_ignore_map_key(controller_name: string, files_comments: Map<string, FileIgnoreMap>) {
 ...
 */
function get_ignore_map(file_name: string | null, files_comments: Map<string, FileIgnoreMap>) {
