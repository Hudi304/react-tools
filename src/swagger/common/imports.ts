...
function print_name_conflict(
  ...
  console.error('Well this is awkward ...')
  console.error('  looks like you have a name conflict between these 2 files :')
  console.error('enum : ', enum_schema)
  console.error('model_map : ', model_schema)
}
